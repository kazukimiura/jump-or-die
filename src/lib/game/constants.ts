 ...
 * 実際、作り直し直後の10本は 346.3 / 398 = 0.870 で、個別検査では捕まらなかった。
 */
export const CHAPTER_DEATH_SUM_LO = 0.85
export const CHAPTER_DEATH_SUM_HI = 1.35
 ...
 * 判定への信頼を削る**。
 *
 * `B = 2` は既習区間に限り許容（警告）。`B <= 1` は無条件で不合格。
 */
export const GATE_B_MIN = 2
export const GATE_B_WARN = 3
